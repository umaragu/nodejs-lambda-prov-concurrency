...
async function initGlobal() {
	...
	const userHandler = app['initGlobals']
  
	if (userHandler == null) {
	  throw new Error(`Handler initGlobals missing on module '${modulePath}'`)
	} else if (typeof userHandler !== 'function') {
	  throw new Error(`Handler initGlobals from '${modulePath}' is not a function`)
	}
	await userHandler();
